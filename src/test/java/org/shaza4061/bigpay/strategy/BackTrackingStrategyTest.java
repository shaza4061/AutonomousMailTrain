...
class BackTrackingStrategyTest {
    private BackTrackingStrategy testObject;

    @BeforeEach
    void setUp() {
        testObject = new BackTrackingStrategy();
    }
    ...
    void testExecuteAtoC() {
        ...
        List<Node> result = testObject.execute(nodeA, nodeC, edges);
        assertEquals(3, result.size());
